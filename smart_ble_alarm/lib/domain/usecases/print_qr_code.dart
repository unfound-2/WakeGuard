        ...
        build: (pw.Context context) {
          return pw.Center(
            child: pw.Column(
              ...
              children: [
                pw.Text('Smart Alarm Key', style: const pw.TextStyle(fontSize: 14)),
                pw.Text('Alarm Identifier: $alarmId', style: const pw.TextStyle(fontSize: 8)),
                ...
                pw.SizedBox(height: 12),
                pw.Text('Scan to dismiss alarm', style: const pw.TextStyle(fontSize: 8)),
              ],
            ),
          );
        },
